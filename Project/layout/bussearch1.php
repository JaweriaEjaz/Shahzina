...
if($c3!=null){
$query=" select * from dateview where Stop_Id='$c3[Stops_Id]'";
 $rows=mysqli_query($con,$query);
}}}}
else{
$query="select * from dateview";
$rows=mysqli_query($con,$query);
}
?>
...
<td><button class='btn ' style='background-color:#ffd000;color:white; '><a style='background-color:#ffd000;color:white; ' href='bookinglayout.php'>BOOK</a></button></td>
</tr>";
}
?>
                        </tbody>
