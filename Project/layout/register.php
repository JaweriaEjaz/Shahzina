                	...
                	<div class="login-page-content"  style="background-color:white;" >
                		<div class="login-form">
                			<h3  style=" color:white">Sign Up</h3>
							 <form class="cmxform form-horizontal style-form" id="signupForm" method="POST" action="Registerinsert.php" enctype="multipart/form-data">
								<div class="name">
									<div class="row">
										<div class="col-md-6">
											<input  style="background-color:white;" type="text" name="name" placeholder="First Name">
										</div>
										<div class="col-md-6">
											<input  style="background-color:white;" type="text" name="username" placeholder="Username">
										</div>
									</div>
								</div>
								<div class="email">
									<input style="background-color:white;" type="email" name="email" placeholder="Email">
								</div>
								<div class="password">
								...
								<div class="log-btn">
									<button style="background-color:black; color:white" name="submit" type="submit"><i class="fa fa-check-square"></i> Sign Up</button>
								</div>
							</form>
                		</div>
                		...
                		<div class="create-ac">
                			<p>Have an account? <a href="loginuser.php"style=" color:#F39C12; font-Size:18px;">Sign In</a></p>
                		</div>
