...
(function ($) {
    ...
    jQuery(document).ready(function ($) {
        ...
        $('#mobileapp-video-bg').YTPlayer({
            ...
            videoURL: 'https://www.youtube.com/watch?v=QWYPRenknK4',
        ...
        $("#slideslow-bg").vegas({
            ...
            slides: [
                {
                    src: 'assetsmainlayout/img/car/1.jpg'
                },
                {
                    src: 'assetsmainlayout/img/car/download.jpg'
                },
                {
                    src: 'assetsmainlayout/img/car/imp2.jpg'
                },
                {
                    src: 'assetsmainlayout/img/slider-img/bus.jpg'
                }
            ]
        }); //Home Page Two Slideshow
